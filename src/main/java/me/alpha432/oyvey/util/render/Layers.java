...
public class Layers {
    ...
    private static final Function<Boolean, RenderLayer> GLOBAL_LINES;

    public static RenderLayer getGlobalLines(boolean width) {
    ...
    static {
        ...
        GLOBAL_LINES = Util.memoize(l -> {
            RenderPhase.LineWidth width = new RenderPhase.LineWidth(OptionalDouble.of(l ? 2.0 : 1.0));
