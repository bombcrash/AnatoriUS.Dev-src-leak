...
public class RenderUtil implements Util {
    ...
    public static void drawBox(MatrixStack stack, Box box, Color c, float lineWidth) {
        ...
        Layers.getGlobalLines(lineWidth > 1.0f).draw(bufferBuilder.end());
    }
    ...
    public static void drawBox(MatrixStack stack, VertexConsumerProvider.Immediate immediate, BlockPos bp, Color c, float outlineValue, float lineWidth) {
        VertexConsumer vertexConsumer = null;
    ...
    public static void drawBoundingBox(MatrixStack matrices, VertexConsumerProvider.Immediate buffer, Box box, float v, float v1, float v2, float v3) {
    }

    public static void drawBoxESP(BlockPos renderPos, Color color, float v, boolean b, boolean b1, Integer value, boolean b2) {
    }

    public static void drawBoxESP(BlockPos renderPos, float v, float v1, float v2, float v3, float v4) {

    }

    public static void drawBoxWithOutline(MatrixStack matrices, BlockPos pos, Color color, Color color1, float v, Vec3d camPos) {
    }
}
